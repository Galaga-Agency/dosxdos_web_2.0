...
const PrivacidadPage: React.FC = () => {
  ...
  useLayoutEffect(() => {
    // Utilizar la función de animación desde el archivo de utilidades
    if (titleRef.current) {
      ...
      <div className="privacidad-page">
        <div className="privacidad-page__container">
          <div className="privacidad-page__header">
            <h1 className="privacidad-page__title" ref={titleRef}>
          ...
          <div className="privacidad-page__content">
            <section className="privacidad-page__section">
              ...
              <p>
                La presente Política de Privacidad ha sido desarrollada teniendo
                en cuenta lo dispuesto por la Ley Orgánica de Protección de
                Datos de carácter personal en vigor, así como por el Reglamento
                2016/679 del Parlamento Europeo y del consejo del 27 de abril de
                2016 relativo a la protección de las personas físicas en lo que
                respecta al tratamiento de datos personales y a la circulación
                de estos datos, en adelante el RGPD.
              </p>
              <p>
                Esta Política de Privacidad tiene por objeto poner en
                conocimiento de los titulares de los datos personales, respecto
                de los cuales se está recabando información, los aspectos
                específicos relativos al tratamiento sus datos, entre otras
                cosas, las finalidades de los tratamientos, los datos de
                contacto para ejercer los derechos que le asisten, los plazos de
                conservación de la información y las medidas de seguridad entre
                otras cosas.
              </p>
            </section>
            ...
            <section className="privacidad-page__section">
              ...
              <p>
                ...
                presente política, concretamente en el apartado Tratamientos de
                datos.
              </p>
              <p>
                A continuación, se indican los datos identificativos del titular
                del presente sitio web:
              </p>
              <ul className="privacidad-page__list">
                ...
                <li>
                  <strong>Dirección electrónica:</strong> informatica@iidos.com
                </li>
              </ul>
            </section>
            ...
            <section className="privacidad-page__section">
              ...
              <p>
                ...
                consistirán únicamente en aquellos estrictamente imprescindibles
                para identificar y atender la solicitud realizada por el titular
                de los mismos, en adelante el interesado. Dicha información será
                tratada de forma leal, lícita y transparente en relación con el
                interesado. Por otra parte, los datos personales serán recogidos
                para finalidades determinadas explícitas y legítimas, no siendo
                tratados ulteriormente de manera incompatible con dichos fines.
              </p>
              <p>
                En la presente web, dospordosgrupoimagen.com, también existe la
                opción de suscribirse al Newsletter, facilitando una dirección
                de correo electrónico, a la que se remitirá la misma.
              </p>
              <p>
              ...
              <p>
                ...
                recogida de sus datos, de los extremos generales regulados en
                esta política a fin de que pueda prestar el consentimiento
                expreso, preciso e inequívoco para el tratamiento de sus datos,
            ...
            <section className="privacidad-page__section">
              ...
              <p>
                Las finalidades explícitas para las cuales se llevan a cabo cada
                uno de los tratamientos vienen recogido en las cláusulas
              ...
              <p>
                No obstante, los datos de carácter personal del interesado serán
                tratados con la exclusiva finalidad de proporcionarles una
                respuesta efectiva y atender las solicitudes practicadas por el
                usuario, especificadas junto a la opción, servicio, formulario o
                sistema de toma de datos que el titular utilice. Los datos
                obtenidos en el alta de Newsletter serán tratados para enviar de
                forma periódica novedades, información relevante y
            ...
            <section className="privacidad-page__section">
              ...
              <p>
                ...
                informado en los diferentes sistemas de recogida de información.
              </p>
              <p>
                No obstante, en caso de que no se requiera el consentimiento del
                interesado, la base legitimadora del tratamiento en la cual se
                ampara DOS POR DOS GRUPO IMAGEN, S.L. es la existencia de una
                ley o norma específica que autorice o exija el tratamiento de
                los datos del interesado.
              </p>
            </section>

            <section className="privacidad-page__section">
              <h3 className="privacidad-page__section-title">Destinatarios</h3>
              <p>
            ...
            <section className="privacidad-page__section">
              ...
              <p>
                ...
                excepciones, los datos pueden ser recogidos a través de terceras
                personas, entidades o servicios diferentes del interesado. En
                este sentido, este extremo será trasladado al interesado a
                través de las cláusulas de consentimiento informado contenidas
                en las diferentes vías de recogida de información y dentro de un
                plazo razonable, una vez obtenidos los datos, y a más tardar
                dentro de un mes.
              </p>
            </section>
            ...
            <section className="privacidad-page__section">
              ...
              <p>
                La información recabada del interesado será conservada mientras
                sea necesaria para cumplir con la finalidad para la cual fueron
                recabados los datos personales, de forma que, una vez cumplida
                la finalidad los datos serán cancelados. Dicha cancelación dará
                lugar al bloqueo de los datos conservándose únicamente a
                disposición de las AAPP, Jueces y Tribunales, para atender las
                posibles responsabilidades nacidas del tratamiento, durante el
                plazo de prescripción de éstas, cumplido el citado plazo se
                procederá a la destrucción de la información.
              </p>
              <p>
                ...
                <table className="privacidad-page__table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>4 años</td>
                      <td>
                        Artículo 21 del Real Decreto Legislativo 5/2000, de 4 de
                        agosto, por el que se aprueba el texto refundido de la
            ...
            <section className="privacidad-page__section">
              ...
              <p>
                ...
                través del sitio web, en caso de que se recojan datos sometidos
                a la normativa, se recomienda consultar la Política de Cookies
            ...
            <section className="privacidad-page__section">
              ...
              <p>
                La normativa en materia de protección de datos otorga una serie
                de derechos a los interesados o titulares de los datos, usuarios
                del sitio web o usuarios de los perfiles de las redes sociales
                de DOS POR DOS GRUPO IMAGEN, S.L.
              </p>
              <p>
              ...
              <ul className="privacidad-page__list">
                <li>
                  ...
                  información sobre si sus propios datos están siendo objeto de
                  tratamiento, la finalidad del tratamiento que se esté
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      Cuando deban suprimirse en cumplimiento de una obligación
                      legal
                    </li>
                    <li>
                ...
                <li>
                  <strong>Derecho de oposición:</strong> derecho a oponerse a un
                  determinado tratamiento basado en el consentimiento del
                  interesado.
                </li>
                <li>
                  <strong>Derecho de limitación:</strong> derecho a obtener la
                  limitación del tratamiento de los datos cuando se de alguno de
                  ...
                  <ul>
                    ...
                    <li>
                      Cuando la empresa ya no necesite los datos para los fines
                      para los que fueron recabados, pero el interesado los
                      necesite para la formulación, el ejercicio o la defensa de
                      reclamaciones.
                    </li>
                    <li>
                ...
                <li>
                  <strong>Derecho a la portabilidad:</strong> derecho a obtener
                  los datos en un formato estructurado, de uso común y de
              ...
              <p>
                ...
                dirigiéndose a DOS POR DOS GRUPO IMAGEN, S.L., mediante escrito,
                remitido a la siguiente dirección: URB. JUAN ASCANIO S/N – 35220
                – TELDE – LAS PALMAS indicando en la línea de Asunto el derecho
                que desea ejercitar.
              </p>
              <p>
            ...
            <section className="privacidad-page__section">
              ...
              <p>
                Las medidas de seguridad adoptadas por DOS POR DOS GRUPO IMAGEN,
                S.L. son aquellas requeridas, de conformidad con lo establecido
                en el artículo 32 del RGPD. En este sentido, DOS POR DOS GRUPO
                IMAGEN, S.L., teniendo en cuenta el estado de la técnica, los
                costes de aplicación y la naturaleza, el alcance, el contexto y
                los fines del tratamiento, así como los riesgos de probabilidad
                y gravedad variables para los derechos y las libertades de las
                personas físicas, tiene establecidas las medidas técnicas y
                organizativas apropiadas para garantizar el nivel de seguridad
                adecuado al riesgo existente.
              </p>
              <p>
                En todo caso, DOS POR DOS GRUPO IMAGEN, S.L. tiene implementados
          ...
          <div className="privacidad-page__mobile-social-section">
            <div className="privacidad-page__mobile-social-header">
              <h3 className="privacidad-page__mobile-social-title">Síguenos</h3>
              <div className="privacidad-page__mobile-social-divider"></div>
            </div>

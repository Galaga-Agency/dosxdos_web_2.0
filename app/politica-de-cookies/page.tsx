            ...
            <div className="cookies-page__content">
              <section className="cookies-page__section">
                ...
                <p>
                  ...
                  realizados y de datos respecto al comportamiento del usuario
                  en Internet.
                </p>
                <p>
                  El sitio web es accesible sin necesidad de que las cookies
                  estén activadas, si bien, su desactivación puede impedir el
              ...
              <section className="cookies-page__section">
                ...
                <p>
                  De conformidad con el aviso de cookies que aparece en este
                  sitio web, el usuario o visitante de los mismos acepta que, al
                  navegar por el mismo, consiente expresamente el uso de cookies
                  según la descripción que se detalla a continuación, excepto en
                  la medida que haya modificado la configuración de su navegador
              ...
              <section className="cookies-page__section">
                ...
                <p>
                  ...
                  facilitar la correcta navegación en el sitio Web, así como
                  para asegurar que el contenido de los mismos se carga
                  eficazmente. Algunas de estas cookies son, además, cookies de
                  sesión es decir que tienen carácter temporal y expiran y se
                  borran automáticamente cuando el usuario cierra su navegador.
                </p>
                ...
                <div className="cookies-page__cookie-types">
                  <div className="cookies-page__cookie-type fade_left">
                    ...
                    <p>
                      ...
                      Ayudan a analizar pautas de tráfico en la web para adecuar
                      a ellas nuestros servicios.
                    </p>
                  </div>
                  ...
                  <div className="cookies-page__cookie-type fade_right">
                    ...
                    <p>
                      Son estrictamente necesarias para navegar por este sitio
                      web y utilizar sus diferentes opciones o servicios.
                    </p>
                  </div>
                </div>
                ...
                <p>
                  ...
                  el mantenimiento técnico y operativo del sitio y garantizar el
                  mejor servicio posible.
                </p>
                <p>
                  <strong>Cookies de Google.com.gstatic.com:</strong> Puede ver
                  la descripción detallada del uso de dichas cookies en:{" "}
                  <a
              ...
              <section className="cookies-page__section">
                ...
                <p>
                  ...
                  actualización del navegador utilizado por éstos. Esta
                  aceptación podrá ser revocada mediante las opciones de
                  configuración de contenidos y privacidad disponibles en el
                  mismo. El Titular recomienda a sus usuarios que consulten la
                  ayuda de su navegador o acceda a las páginas web de ayuda de

...
import {
  animateTitle,
  cleanupAvisoLegalAnimations,
} from "@/utils/animations/pages/aviso-legal-page-anim";
      ...
      <div className="aviso-legal-page">
        <div className="aviso-legal-page__container">
          <div className="aviso-legal-page__header">
            <h1 className="aviso-legal-page__title" ref={titleRef}>
              AVISO LEGAL
            </h1>
          </div>
          ...
          <div className="aviso-legal-page__content">
            <section className="aviso-legal-page__section">
              ...
              <p>
                ...
                web iidos.com, del que es titular DOS POR DOS GRUPO IMAGEN, S.L.
              ...
              <p>
                ...
                web de conformidad con las leyes, la buena fe, el orden público,
                los usos del tráfico y el presente Aviso Legal, y responderá
                frente a EL PROPIETARIO DE LA WEB o frente a terceros, de
              ...
              <p>
                ...
                prohibida, pudiendo EL PROPIETARIO DE LA WEB denegar o retirar
                el acceso y su uso en cualquier momento.
              </p>
            </section>
            ...
            <section className="aviso-legal-page__section">
              ...
              <p>
                EL PROPIETARIO DE LA WEB, en cumplimiento de la Ley 34/2002, de
                11 de julio, de Servicios de la Sociedad de la Información y de
                Comercio Electrónico, le informa de que:
              </p>
              <ul className="aviso-legal-page__list">
                <li>
                  <strong>Su denominación social es:</strong> DOS POR DOS GRUPO
                  IMAGEN, S.L.
                </li>
                <li>
            ...
            <section className="aviso-legal-page__section">
              ...
              <p>
                ...
                obstante, PROPIETARIO DE LA WEB puede condicionar la utilización
                de algunos de los servicios ofrecidos en su web a la previa
              ...
              <p>
                ...
                los contenidos y servicios de PROPIETARIO DE LA WEB y a no
              ...
              <ul className="aviso-legal-page__list">
                ...
                <li>
                  ...
                  sistemas físicos y lógicos de PROPIETARIO DE LA WEB o de
                  terceras personas; así como obstaculizar el acceso de otros
                  usuarios al sitio web y a sus servicios mediante el consumo
                  masivo de los recursos informáticos a través de los cuales
                ...
                <li>
                  ...
                  de PROPIETARIO DE LA WEB o de terceros y, en su caso, extraer
                  información.
                </li>
                <li>
              ...
              <p>
                ...
                visualizar los contenidos y efectuar, en su caso, copias
                privadas autorizadas siempre que los elementos reproducidos no
              ...
              <p>
                ...
                propiedad de PROPIETARIO DE LA WEB, sin que pueda entenderse que
                el uso o acceso al mismo atribuya al usuario derecho alguno
                sobre los mismos.
              </p>
              <p>
                La distribución, modificación, cesión o comunicación pública de
                los contenidos y cualquier otro acto que no haya sido
            ...
            <section className="aviso-legal-page__section">
              ...
              <p>
                ...
                tiene una finalidad meramente informativa, sin que se garantice
                plenamente el acceso a todos los contenidos, ni su
              ...
              <ul className="aviso-legal-page__list">
                <li>
                  ...
                  almacenados, puestos a disposición, a los que se haya accedido
                ...
                <li>
                  ...
                  y a modo ejemplificativo, PROPIETARIO DE LA WEB no se hace
                  responsable de las actuaciones de terceros que vulneren
                  derechos de propiedad intelectual e industrial, secretos
                  empresariales, derechos al honor, a la intimidad personal y
                  familiar y a la propia imagen, así como la normativa en
                  materia de competencia desleal y publicidad ilícita.
                </li>
              </ul>
              <p>
                Asimismo, PROPIETARIO DE LA WEB declina cualquier
                responsabilidad respecto a la información que se halle fuera de
                esta web y no sea gestionada directamente por nuestro webmaster.
                La función de los links que aparecen en esta web es
                exclusivamente la de informar al usuario sobre la existencia de
                otras fuentes susceptibles de ampliar los contenidos que ofrece
                este sitio web. PROPIETARIO DE LA WEB no garantiza ni se
                responsabiliza del funcionamiento o accesibilidad de los sitios
                enlazados; ni sugiere, invita o recomienda la visita a los
                mismos, por lo que tampoco será responsable del resultado
            ...
            <section className="aviso-legal-page__section">
              ...
              <p>
                ...
                existen hechos o circunstancias que revelen el carácter ilícito
                de la utilización de cualquier contenido y/o de la realización
                de cualquier actividad en las páginas web incluidas o accesibles
                a través del sitio web, deberá enviar una notificación a
                PROPIETARIO DE LA WEB identificándose debidamente y
                especificando las supuestas infracciones.
              </p>
            </section>

            <section className="aviso-legal-page__section">
              <h3 className="aviso-legal-page__section-title">Publicaciones</h3>
              <p>
                La información administrativa facilitada a través del sitio web
                no sustituye la publicidad legal de las leyes, normativas,
                planes, disposiciones generales y actos que tengan que ser
                publicados formalmente a los diarios oficiales de las
                administraciones públicas, que constituyen el único instrumento
                que da fe de su autenticidad y contenido. La información
                disponible en este sitio web debe entenderse como una guía sin
                propósito de validez legal.
              </p>
            </section>
          ...
          <div className="aviso-legal-page__mobile-social-section">
            <div className="aviso-legal-page__mobile-social-header">
              ...
              <div className="aviso-legal-page__mobile-social-divider"></div>
            </div>
